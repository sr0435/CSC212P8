...
public class CheckSpelling {
	...
	public static List<String> createMixedDataset(List<String> yesWords, int numSamples, double fractionYes) {
		...
		// number of actual words we need
		...
		for (int i=0;i<numSamples;i++) {
			if (i<numYesWords) {
				...
				// makes all the originally right words wrong and adds them
				// after we've used up our correct words
	...
	public static void main(String[] args) {
		...
		// charTrie test
		/*
		 * CharTrie trie2 = new CharTrie(); List<String> testList =
		 * Arrays.asList("a","b","c","d", "e"); for (String w : testList) {
		 * trie2.insert(w); } System.out.println(trie2.countNodes());
		 */
